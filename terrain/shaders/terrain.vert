...
vec3 compute_normal(vec2 uv) {
  ...
  float h00 = altitude_from_color_2(textureOffset(u_height_texture, uv, ivec2(-1,0)));
  float h01 = altitude_from_color_2(textureOffset(u_height_texture, uv, ivec2(+1,0)));
  float h10 = altitude_from_color_2(textureOffset(u_height_texture, uv, ivec2(0,-1)));
  float h11 = altitude_from_color_2(textureOffset(u_height_texture, uv, ivec2(0,+1)));
...
void main() {
  ...
  out_normal = compute_normal(scaled_uv);
