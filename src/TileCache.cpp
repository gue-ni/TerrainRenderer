...
TileCache::TileCache(const TileId& root_tile, unsigned max_zoom_level)
    : m_root_tile(root_tile),
      ...
      m_ortho_tile_service("https://gataki.cg.tuwien.ac.at/raw/basemap/tiles", ThreadedTileService::UrlPattern::ZYX_Y_SOUTH,
                           ".jpeg"),
      m_height_tile_service("https://alpinemaps.cg.tuwien.ac.at/tiles/alpine_png", ThreadedTileService::UrlPattern::ZXY, ".png")
